      ...
      <div className="container mx-auto px-6">
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-12 mb-20">
          <div className="space-y-6">
            <button 
              onClick={onHomeClick}
              className="text-3xl font-rounded font-bold text-left outline-none"
            >
              Khan's Art
            </button>
          ...
          <div className="space-y-6">
            ...
            <ul className="space-y-4 text-[#F5F0E8]/70">
              ...
              <li><a href="#gallery" className="hover:text-white transition-colors">Галерея работ</a></li>
          ...
          <div className="space-y-6">
            ...
            <div className="text-[#F5F0E8]/70 space-y-2">
              ...
              <div className="mt-4 p-4 border border-white/10 rounded-2xl bg-white/5">
                ...
                <button className="bg-[#8B6F5C] text-white w-full py-2 rounded-lg text-sm font-bold hover:bg-[#C49A7C] transition-colors">
                  Забронировать время
                </button>
              </div>
            </div>
